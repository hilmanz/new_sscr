	...
	<div id="container">
        ...
        <div class="row">
            <div class="box-grey">
            	<div class="infoDetailEvent">                            
                    <h1 class="yellow textbg"><span class="startDates">14/04/2015</span>  <span class="dashDates">&ndash;</span> <span class="endDates">15/04/2015</span></h1>
                    <p class="">Waktu: 10:00 PM - 03:30 AM</p>                
                    <h1 class="">EVENT C Chapter 1<br /><span class="categoryEvents">Nobar</span></h1>
                    <p>Cafe cafe an</p>
        ...
        <div class="rowss" style="overflow:inherit;">
            ...
            <div class="uploadFoto">
            	 ...
            	 <div class="imagePost  ros1"><img width="150" data-row="1" class="filimg ros1" src="images/suporter1.jpg"></div>
                 <div class="imagePost  ros1"><img width="150" data-row="1" class="filimg ros1" src="images/suporter2.jpg"></div>
            </div>
        </div><!--end.rows-->
