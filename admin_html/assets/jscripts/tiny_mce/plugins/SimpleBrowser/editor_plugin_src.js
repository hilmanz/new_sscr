...
(function() {
	...
	tinymce.create('tinymce.plugins.SimpleBrowser', {
		/**
		...
		getInfo : function() {
			return {
				longname : 'SimpleBrowser Plugin',
				author : 'Hapsoro Renaldy N <hapsoro.renaldy at yahoo.com>',
				authorurl : 'N/A',
				infourl : 'N/A',
				version : "1.0",
				plugin_url : url
	...
	// Register plugin
	tinymce.PluginManager.add('SimpleBrowser', tinymce.plugins.SimpleBrowser);
})();