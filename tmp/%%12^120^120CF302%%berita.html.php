<?php /* Smarty version 2.6.13, created on 2016-09-06 14:45:50
         compiled from application/web/apps/berita.html */ ?>
		...
		<section class="section" style="padding-top:50px">
			<div class="container">
				<header class="section-header no-border">
					<figure>
						<img src="assets/images/supersoccer-logo.png">
					</figure>
				</header>
							...
							<article class="post post-showinfo">
								<div class="post-media overlay">
									<a class="feature-image magnific hover-animate" href="assets/images/news/news_00.jpg" title="Thats a nice image">
										<img alt="some image" src="assets/images/news/news_00.jpg">
											...
											<article class="post post-showinfo">
												<div class="post-media">
													<a class="feature-image magnific hover-animate" href="assets/images/news/news_01.jpg" title="Thats a nice image">
														<img alt="some image" src="assets/images/news/news_01.jpg">
														<i class="fa fa-search-plus"></i>
													</a>
												</div>
											...
											<article class="post post-showinfo">
												<div class="post-media">
													<a class="feature-image magnific hover-animate" href="assets/images/news/news_02.jpg" title="Thats a nice image">
														<img alt="some image" src="assets/images/news/news_02.jpg">
														<i class="fa fa-search-plus"></i>
													</a>
												</div>
												<div class="post-head text-center">
											...
											<article class="post post-showinfo">
												<div class="post-media">
													...
													data-flex-controlsposition="" data-flex-directions-type="">
														<ul class="slides">
															<li>
																<img src="assets/images/news/news_03.jpg" alt="some image">
															</li>
															<li>
																<img src="assets/images/news/news_08.jpg" alt="some image">
															</li>
														</ul>
													</div>
												</div>
											...
											<article class="post post-showinfo">
												<div class="post-media">
													...
													data-flex-controlsposition="" data-flex-directions-type="">
														<ul class="slides">
															<li>
																<img src="assets/images/news/news_04.jpg" alt="some image">
															</li>
															<li>
																<img src="assets/images/news/news_05.jpg" alt="some image">
															</li>
														</ul>
													</div>
												</div>
											...
											<article class="post post-showinfo">
												<div class="post-media">
													<a class="feature-image magnific-youtube hover-animate" href="https://www.youtube.com/watch?v=WR9vJzJgF8s" title="Thats a nice image">
														<img alt="some image" src="assets/images/news/news_04.jpg">
														<i class="fa fa-play"></i>
													</a>
												</div>
												<div class="post-head text-center">
											...
											<article class="post post-showinfo">
												<div class="post-media">
													<a class="feature-image magnific hover-animate" href="assets/images/news/news_07.jpg" title="Thats a nice image">
														<img alt="some image" src="assets/images/news/news_07.jpg">
														<i class="fa fa-search-plus"></i>
													</a>
												</div>
												<div class="post-head text-center">
											...
											<article class="post post-showinfo">
												<div class="post-media">
													<a class="feature-image magnific-vimeo hover-animate" href="https://www.youtube.com/watch?v=hnEiUpCNBfo" title="Let&#x27;s talk about it">
														<img alt="some image" src="assets/images/news/news_08.jpg">
														<i class="fa fa-play"></i>
													</a>
												</div>
												<div class="post-head text-center">
