...
<div id="registration-confirm" class="section">
	<div id="container">
    	<div class="row-2">
             <p class="tittleForm"><strong>SELAMAT DATANG DI DSS GTE</strong></p>
        ...
        <div class="formregis">
            ...
            <div class="row">
                <a  href="index.php?menu=member-profile" class="button">LANJUT</a>
            </div>
        </form>
        </div>
    </div><!--end#container-->
